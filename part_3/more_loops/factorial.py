...
In other words, it is the product of all positive integers less than or equal to the number. For example, the factorial of 5 is 1 * 2 * 3 * 4 * 5 = 120.
...
while True:
    ...
    print(f"The factorial of the number {num} is {factoral}")
